...
import com.terrylt.todoSpringVue.appuser.AppUserRole;
import com.terrylt.todoSpringVue.appuser.AppUserService;
import com.terrylt.todoSpringVue.appuser.email.EmailService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest registrationRequest){
        ...
        emailService.send(registrationRequest.getEmail(),buildEmail(registrationRequest.getUsername(),link));
        return token;
    }
    ...
    public String confirmToken(String token){
        ...
        ConfirmationToken confirmationToken = confirmationTokenService.
                getConfirmationToken(token).orElseThrow(()-> new IllegalStateException("The token does not exists"));
